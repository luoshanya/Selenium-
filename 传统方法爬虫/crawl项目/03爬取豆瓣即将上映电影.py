...
class Spider_newsMoviser():
    ...
    def Spider_requests(self,url):
        data = requests.get(url,headers=self.headers,verify=False).content.decode('utf-8')
        return data
        #解析数据
    ...
    def save_json_data(self):
        json_data = json.dump(self.list,open('豆瓣即将上映影片.json','w',encoding='utf-8'))
    ...
    def save_csv_data(self):
        ...
        read_json_data = json.load(open_json_data)
