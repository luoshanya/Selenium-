...
class Spider_qcwy(object):
    def __init__(self):
        self.url = 'https://search.51job.com/list/030000,000000,0000,00,9,99,python,2,{}.html?'
        self.headers = {
    ...
    def request_url(self,url):
        ...
        #
        # json_file = json.dump(self.list_data,open('01传统抓取51职业信息.json','w',encoding='utf-8'))
